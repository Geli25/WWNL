...
squiffy.story.sections = {
  'Beginning': {
		'text': "<p>In your world, there is something that everyone believes in. Something unimaginable to those a century ago. That &#39;something&#39; reconstructed the way you think about life, death, and reality. But to the people today, that &#39;something&#39; has become so integrated in their lives that it is common sense, like &#39;social media&#39; in the Digital Age. </p>\n<p><a class=\"squiffy-link link-section\" data-section=\"_continue1\" role=\"link\" tabindex=\"0\">And yet...</a></p>",
	...
	'_continue1': {
		...
		'passages': {
			...
			'the Connection': {
				'text': "<p>In your world today, &#39;the Connection&#39;(yes, with a capital C) is the conduit between the physical world and the Spiritual Realm. It allows you to communicate with the dead, particularly your loved ones, who return through the Connection as entities known as <a class=\"squiffy-link link-passage\" data-passage=\"the Spirits\" role=\"link\" tabindex=\"0\">the Spirits</a>. </p>",
			},
			'the Spirits': {
	...
	'transition': {
		...
		'passages': {
			...
			'gym shorts': {
				'text': "<p>The gym shorts hang loose on the child, a painful indication of how scrawny they are. The elastic sticks out of the waist, and is tied into a tight knot to prevent the pants from falling.</p>",
			},
			'window': {
	...
	'_continue4': {
		...
		'passages': {
			'a skyscraper': {
				'text': "<p>The skyscraper is one of the most distinct landmarks because it is the control center of technology in this city. Its design is that of a spiralling double helix, and has a constant faint glow though more visible at night.</p>\n<p>It is known as the <a class=\"squiffy-link link-section\" data-section=\"G.D.O Tower\" role=\"link\" tabindex=\"0\">G.D.O Tower</a>. </p>",
			},
		},
	},
	'G.D.O Tower': {
	...
	'_continue8': {
		...
		'passages': {
			...
			'Natt\'s house': {
				'text': "<p>Natt’s been your best friend since childhood. You had a fallout with them in your teenage years when others kept mistaking you for a couple, but you made up quickly after realizing how stupid it was to let other people&#39;s decisions influence you. Natt is always the type that holds themselves straight, and without their positivity you aren’t sure you would have made it this far. They’ve been worried about you ever since your significant other was infected by the Plague, and you can always use the comfort of your friends. Perhaps you should pay a visit?</p>",
			},
			'CyBeer': {
	...
	'_continue9': {
		'text': "<p>Natt makes a &quot;come in&quot; gesture with their chin, and, without a word, you take off your shoes in front of the door and step inside.</p>\n<p>In an instant, you hear a loud bark from one of the rooms in the apartment, and you see {label:3=<a class=\"squiffy-link link-passage\" data-passage=\"a dog spirit\" role=\"link\" tabindex=\"0\">a dog spirit</a>} running towards you.</p>\n<p>&quot;Rugby, stay!&quot; Rugby halts instantly at Natt&#39;s order, but wriggles excitedly  and licks their chops. &quot;Sorry about that, Aki.&quot; Natt apologizes and presses their credit card on a card reader. After a beep, Rugby disappears. &quot;I wasn&#39;t expecting company today.&quot;</p>\n<p>&quot;It&#39;s fine.&quot; You take a seat on the couch. &quot;I haven&#39;t seen them in a long time, anyway.&quot;</p>\n<p>Natt lets out a dry laugh and sits beside you. They are silent again, and seem to be very keen on observing their knee. Watching their mouth open and close at multiple attempts of conversation, you know that they are struggling with what to say. &quot;Being careful with your words is good, Natt.&quot; You try to help break the ice a bit. &quot;But careful not to hurt yourself.&quot;</p>\n<p><a class=\"squiffy-link link-section\" data-section=\"_continue10\" role=\"link\" tabindex=\"0\">...</a></p>",
		'passages': {
			'a dog spirit': {
				'text': "<p>A Dalmatian, they had been with Natt ever since they were little. They spent 15 years with Natt before dying of old age, and you remember how much Natt was crying during their funeral. Rugby is the main reason that they installed <a class=\"squiffy-link link-passage\" data-passage=\"360 Projection\" role=\"link\" tabindex=\"0\">360 Projection</a> in their new home, so that even after death, Rugby can remain by Natt&#39;s side. Natt would never admit it though. </p>",
	...
	'Hospital': {
		...
		'passages': {
			...
			'cremated': {
				'text': "<p>Historically, the cremation process was organized through a &#39;cemetery&#39;. This process was quickly taken over by hospitals when the Connection opened its access to civilians, making it much more affordable, taking much of the meaning out of venerating the deceased. Soon, all lands dedicated to that ceremony were taken for government use  although one or two were still preserved as a part of a museum. Since the Connection access is strictly granted by the government, hospitals also took over the Death Certificate process.</p>",
			},
			'Dr.Lee': {
	...
	'_continue24': {
		'text': "<p>You turn around to see your desk buddy, <a class=\"squiffy-link link-passage\" data-passage=\"Aidan\" role=\"link\" tabindex=\"0\">Aidan</a>, looking at you with resentful eyes. &quot;How dare you drop by work to see how everyone is doing, showing off how happy and rested you are. Don’t let me see your stupid face here again.&quot;</p>\n<p>You lift an eyebrow at them. They certainly look more exhausted than usual. &quot;Don&#39;t you think it&#39;s a bit of a mean greeting?&quot;</p>\n<p>&quot;Naw, I&#39;ve been practically living here for the past couple days, I haven&#39;t talked to my lover in weeks-&quot; They instantly shut their mouth when they mention their lover, and looks at you with wide eyes of panic.</p>\n<p>You realize that it is a sensitive subject, and you prefer not to talk about it too much, but the way they react to their own words seems so comical that you almost had the energy to laugh.</p>\n<p>A smile tugs at the corner or your mouth instead. &quot;It&#39;s fine. But I&#39;m actually here for something today, are you busy?&quot;</p>\n<p>Aidan jabs at the door of the glass conference room behind them. &quot;Well, the boss just had a big meeting with all of us saying about the possibility of a system overload. And with the amount of dead people energy in the air...&quot; They flit their fingers around. &quot;It is easy to get energy data mixed up, so some of us are assigned to go through verifications of making sure that there are no mistakes.&quot;</p>\n<p>Despite how exhausted and disheveled they look, you begin to see Aidan in a new light. Aidan may be able to help you in your investigation.</p>\n<p><a class=\"squiffy-link link-section\" data-section=\"_continue25\" role=\"link\" tabindex=\"0\">...</a></p>",
		'passages': {
			'Aidan': {
	...
	'_continue25': {
		...
		'passages': {
			'Code': {
				'text': "<p>There is only one language used by the G.D.O that manages the networks. Since it is completely in-house and confidential, there is no particular name for this language, so all the workers just refer to it as the Code. Its language mostly consists of identifying the energy and ensuring communication between the two worlds.</p>",
			},
		},
	},
	'_continue26': {
	...
	'transition8': {
		'text': "<p>You sometimes wonder if work therapy is actually a thing, because diving headfirst into your work and investigation has made you feel purpose in life.</p>\n<p>Although working on Maintenance is not the most exciting job ever, you were able to gain first hand access to all the most recent datasets,since most of your job was involved with energy check-ups and data cleaning to prevent errors from an overflow of Spirits.</p>\n<p>Gathering data and clues is more difficult than you imagined. It’s excruciatingly exhausting, so you simply pick out the information and copy it into your <a class=\"squiffy-link link-passage\" data-passage=\"log\" role=\"link\" tabindex=\"0\">log</a>. Fortunately, with Fuyuhiro helping you, you’re able to expand the scale of your own dataset. You find yourself envying that Spirits don’t need food or sleep to function.</p>\n<p>It’s been 4 months since you went back to work, and the Plague situation has finally started to calm down. G.D.O sent workers messages thanking them for their hard work.</p>\n<p>Back home, you sit with Fuyuhiro, staring at your computers. Once again, you have paid to disConnect your parents. </p>\n<p>You open up your log.</p>\n<p><a class=\"squiffy-link link-section\" data-section=\"_continue27\" role=\"link\" tabindex=\"0\">...</a></p>",
		'passages': {
			'log': {
